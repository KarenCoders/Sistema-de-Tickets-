...
const TutorialSection = ({ activeTab }) => {
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-slate-500 text-lg">
          Aprendiendo a auditar y mantener software profesionalmente.
        </p>
      </header>
      ...
      <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <li className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            <strong>Regla de Oro:</strong> Automatiza lo que puedas, revisa
            manualmente lo lógico.
          </li>
        </ul>
      </section>
      ...
      <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
        ...
        <p className="text-slate-600 mb-6">
          Para gestionar el mantenimiento eficazmente, cada solicitud debe ser
          categorizada y priorizada.
        </p>
